...
curl https://raw.githubusercontent.com/gjpin/steam-deck/main/configs/flatpak/com.github.mtkennerly.ludusavi -o ${HOME}/.local/share/flatpak/overrides/com.github.mtkennerly.ludusavi

# Import Ludusavi config
mkdir -p ${HOME}/.var/app/com.github.mtkennerly.ludusavi/config/ludusavi
curl https://raw.githubusercontent.com/gjpin/steam-deck/main/configs/ludusavi/config.yaml | envsubst > ${HOME}/.var/app/com.github.mtkennerly.ludusavi/config/ludusavi/config.yaml
